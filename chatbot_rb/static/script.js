...
function analyzeTone() {
  fetch("/analyze_tone", {
    ...
    .then((response) => response.json())
    .then((data) => {
      console.log("Tone Analysis:", data.songs); // Handle the tone analysis result
      ...
      data.songs.forEach((song) => {
        ...
        songElement.innerHTML = `
                <div class="song-info">
                    <div class="song-info image-container">
        ...
        songElement.addEventListener("click", function () {
          window.open(song.url, "_blank"); // Open URL in a new tab
        });
